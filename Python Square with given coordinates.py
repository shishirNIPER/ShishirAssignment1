...
Original file is located at
    https://colab.research.google.com/drive/1uw46Mc72mxkvg0nZwi6AElpeaYnEBjPM
"""
...
plt.plot(A[0], A[1], 'o')
plt.text(1,2,'A', weight = "bold")
plt.plot(B[0], B[1], 'o')
plt.text(5,4,'B',weight = "bold")
plt.plot(C[0], C[1], 'o')
plt.text(3,8,'C', weight = "bold")
plt.plot(D[0], D[1], 'o')
plt.text(-1,6,'D', weight = "bold")
